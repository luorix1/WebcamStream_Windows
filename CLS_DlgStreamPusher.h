...
public:
	...
	**********************/
	...
	afx_msg void OnStnClickedStcPreview();
	afx_msg void OnStnClickedStcResolution();
	afx_msg void OnBnClickedEndPreview();
	afx_msg void OnEnChangeGetname();
	afx_msg void OnEnChangeGetid();
	afx_msg void OnEnChangeEdtFramerate();
	afx_msg void OnBnClickedBtnLogin();
	afx_msg void OnBnClickedBtnEndpoint();
	afx_msg void OnStnClickedStcPusherAddr();
	afx_msg void OnBnClickedTermination();
	afx_msg void OnStnClickedStcFrame();
};
